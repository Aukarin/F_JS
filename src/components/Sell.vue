<template>
  ...
  <div id="app">
    ...
    <a class="button is-info"    @click=" onGoClick()" >ย้อนกลับ </a>
     <div v-if="items.length < 1" >
     <br>
      <br> <br> <br> <br> <br> <br>  <br>  <br>
        <h1> ยังไม่มี order เข้า </h1>
    </div>
...
<div class="product-image" v-if="item.Name=='adidas'" >
 ...
 <div  align = center>
         <br>
             <br>
          <span
            @click="isSelected(item) ?  unselect() : removeItem(item, i)"
          >     
        <a class="btn btn-secondary btn-lg btn-block" @click="isSelected(item)" width=180 > ส่งสินค้า </a>
